...
occs_path <- "C:/Users/maxpe/Documents/Bren Courses/ESM 270p/data/new_data/occurrence_data/gbif/"
occs_path <- file.path(occs_path, "sp_occur_wallace_scm_clip.csv")
# get a list of species occurrence data
userOccs_Bm <- occs_userOccs(
  txtPath = occs_path, 
  txtName = "sp_occur_wallace_scm_clip.csv", 
  txtSep = ",", 
  txtDec = ".")
...
n <- mxNonzeroCoefs(model_Bm@models[["fc.L_rm.1"]], "maxnet")

# Create response curves
for (i in n) {
maxnet::response.plot(
  model_Bm@models[["fc.L_rm.1"]],
  v = i,
  type = "cloglog")
}
```
...
output_filepath <- "C:/Users/maxpe/Documents/Bren Courses/ESM 270p/scm_mamu_suitability.tif" 
